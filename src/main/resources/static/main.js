...
if (document.getElementById('v-pills-admin')) {
    ...
    const renderEditModalFormContent = (user) => {
        document.getElementById('editForm').innerHTML = `
            ...
            <label class="form-label d-block mx-auto pt-1 mt-3 mb-0 text-center fs-5 fw-bold">Пароль
                <input id="passwordEdit" value="" type="text" class="form-control mx-auto" style="width: 250px;" placeholder="Новый пароль"></label>
    ...
    const renderDeleteModalContent = (user) => {
        let content = `
            ...
            <label class="form-label d-block mx-auto pt-1 mt-3 mb-0 text-center fs-5 fw-bold">Имя</label>
            <input value="${user.firstName}" disabled type="text" class="form-control mx-auto" style="width: 250px;">
            <label class="form-label d-block mx-auto pt-1 mt-3 mb-0 text-center fs-5 fw-bold">Фамилия</label>
            <input value="${user.lastName}" disabled type="text" class="form-control mx-auto" style="width: 250px;">
            <label class="form-label d-block mx-auto pt-1 mt-3 mb-0 text-center fs-5 fw-bold">Возраст</label>
            ...
            <label class="form-label d-block mx-auto pt-1 mt-3 mb-0 text-center fs-5 fw-bold">Роли</label>
    ...
    const userCreated = (userCreated) => {
        sendRequestInfo('POST', '/admin/', userCreated).then(user => {
    ...
    document.getElementById('editForm').addEventListener('submit', (event) => {
        ...
        allUsersTableRowUpdate(userEdited);
    });
